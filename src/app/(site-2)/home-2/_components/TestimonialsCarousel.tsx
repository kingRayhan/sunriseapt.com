          ...
          >
            ...
            <div className="mt-10 flex gap-4 sm:mt-12">
              <button
                type="button"
                onClick={goPrev}
                className="inline-flex size-11 items-center justify-center rounded-sm border border-foreground/25 text-foreground transition-opacity duration-200 hover:bg-muted/60 hover:opacity-90 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring motion-reduce:transition-none"
