        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Founded in 2015, Sunriseapt began with a simple belief: finding a
              home should be an exciting journey, not a stressful ordeal. What
              started as a boutique agency in Miami has grown into one of South
              Florida&apos;s most trusted real estate firms.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              We&apos;ve helped over 500 families find their perfect homes, from
              beachfront condos to sprawling family estates. Our approach
              combines deep local expertise with genuine care for every
              client&apos;s unique needs and aspirations.
            </p>
          </div>
        </div>
      </section>
